...
const FloatBtn = () => {
    ...
    return (
        <div className=' fixed bottom-4 lg:bottom-12 lg:right-10 right-4 z-50'>
            <select onChange={LangSwitch} value={selectedValue} className="cursor-pointer text-base lg:text-lg appearance-none rounded-full bg-main/60 backdrop-blur-lg shadow-lg text-center focus:outline-none text-white w-12 h-12 relative">
